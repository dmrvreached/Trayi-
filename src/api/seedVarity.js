...
const Service = require("../services/seedVarity-service");
...
module.exports = (app) => {
    ...
    app.post("/seedVarity", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.delete("/seedVarity", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/seedVarity", UserAuth, async (req, res, next) => {
    try {
