...
const Service = require("../services/harvesting-service");
...
module.exports = (app) => {
    ...
    app.post("/harvesting", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/harvesting", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/harvesting", UserAuth, async (req, res, next) => {
        try {
