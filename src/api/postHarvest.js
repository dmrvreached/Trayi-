const StateService = require("../services/postHarvest-service");
...
module.exports = (app) => {
  ...
  app.post("/postHarvest", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/postHarvest", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/postHarvest", UserAuth, async (req, res, next) => {
    try {
