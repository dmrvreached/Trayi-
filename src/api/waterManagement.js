...
const Service = require("../services/waterManagement-service");
...
module.exports = (app) => {
    ...
    app.post("/waterManagement", UserAuth, async (req, res, next) => {
    try {
    ...
    app.delete("/waterManagement", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/waterManagement", UserAuth, async (req, res, next) => {
    try {
