...
const Service = require("../services/plotDetails-service");
...
module.exports = (app) => {
    ...
    app.post("/plotDetails", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/plotDetails", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/plotDetails", UserAuth, async (req, res, next) => {
        try {
    ...
    app.post("/plotDetails/offline", UserAuth, async (req, res, next) => {
        try {
