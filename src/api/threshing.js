...
const Service = require("../services/threshing-service");
...
module.exports = (app) => {
    ...
    app.post("/threshing", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.delete("/threshing", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/threshing", UserAuth, async (req, res, next) => {
    try {
