...
const Service = require("../services/irrigation-service");
...
module.exports = (app) => {
    ...
    app.post("/irrigation", UserAuth, async (req, res, next) => {
        try {
    ...
    app.delete("/irrigation", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/irrigation", UserAuth, async (req, res, next) => {
        try {
