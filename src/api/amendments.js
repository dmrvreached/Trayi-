...
const Service = require("../services/amendments-service");
...
module.exports = (app) => {
    ...
    app.post("/amendments", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/amendments", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/amendments", UserAuth, async (req, res, next) => {
        try {
