const StateService = require("../services/organicInputs-service");
...
module.exports = (app) => {
  ...
  app.post("/organicInputs", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/organicInputs", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/organicInputs", UserAuth, async (req, res, next) => {
    try {
