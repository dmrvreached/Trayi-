...
const Service = require("../services/sowing-service");
...
module.exports = (app) => {
    ...
    app.post("/sowing", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/sowing", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/sowing", UserAuth, async (req, res, next) => {
        try {
