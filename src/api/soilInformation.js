...
const Service = require("../services/soilInformation-service");
...
module.exports = (app) => {
    ...
    app.post("/soilInformation", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/soilInformation", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/soilInformation", UserAuth, async (req, res, next) => {
        try {
    ...
    app.post("/soilInformation/offline", UserAuth, async (req, res, next) => {
        try {
