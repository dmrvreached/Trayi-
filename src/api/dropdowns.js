const Service = require("../services/dropdowns-service");
...
module.exports = (app) => {
  ...
  app.post("/dropdown", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/dropdown", UserAuth, async (req, res, next) => {
    try {
  ...
  app.get("/dropdowns", UserAuth, async (req, res, next) => {
    try {
