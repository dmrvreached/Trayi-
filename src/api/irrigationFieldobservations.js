...
const Service = require("../services/irrigationfielObservations-service");
...
module.exports = (app) => {
    ...
    app.post("/irrigationFieldObservations", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/irrigationFieldObservations", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/irrigationFieldObservations", UserAuth, async (req, res, next) => {
        try {
