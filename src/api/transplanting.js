...
const Service = require("../services/transplanting-service");
...
module.exports = (app) => {
    ...
    // To listen
    app.post("/transplanting", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/transplanting", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/transplanting", UserAuth, async (req, res, next) => {
        try {
