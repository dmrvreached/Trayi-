...
const Service = require("../services/weeding-service");
...
module.exports = (app) => {
    ...
    app.post("/weeding", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.delete("/weeding", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/weeding", UserAuth, async (req, res, next) => {
    try {
