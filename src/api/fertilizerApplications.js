...
const Service = require("../services/fertilizerApplications-service");
...
module.exports = (app) => {
    ...
    app.post("/fertilizerApplications", UserAuth, async (req, res, next) => {
        try {
    ...
    app.delete("/fertilizerApplications", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/fertilizerApplications", UserAuth, async (req, res, next) => {
        try {
