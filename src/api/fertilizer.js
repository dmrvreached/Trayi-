const StateService = require("../services/ferilizer-service");
...
module.exports = (app) => {
  ...
  app.post("/fertilizer", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/fertilizer", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/fertilizers", UserAuth, async (req, res, next) => {
    try {
