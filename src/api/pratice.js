...
const Service = require("../services/pratice-service");
...
module.exports = (app) => {
    ...
    app.post("/pratice", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.delete("/pratice", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/pratice", UserAuth, async (req, res, next) => {
    try {
