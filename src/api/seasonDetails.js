...
const Service = require("../services/seasonDetails-service");
...
module.exports = (app) => {
    ...
    app.post("/seasonDetails", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/seasonDetails", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/seasonDetails", UserAuth, async (req, res, next) => {
        try {
    ...
    app.post("/seasonDetails/offline", UserAuth, async (req, res, next) => {
        try {
