...
const Service = require("../services/nitrogenFertilizers-service");
...
module.exports = (app) => {
    ...
    app.post("/nitrogenFertilizers", UserAuth, async (req, res, next) => {
        try {
    ...
    app.delete("/nitrogenFertilizers", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/nitrogenFertilizers", UserAuth, async (req, res, next) => {
        try {
