...
const Service = require("../services/drying-service");
...
module.exports = (app) => {
    ...
    app.post("/drying", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/drying", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/drying", UserAuth, async (req, res, next) => {
        try {
