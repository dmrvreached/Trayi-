...
const Service = require("../services/operationDates-service");
...
module.exports = (app) => {
    ...
    app.post("/operationDates", UserAuth, async (req, res, next) => {
        try {
    ...
    app.delete("/operationDates", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/operationDates", UserAuth, async (req, res, next) => {
        try {
