...
module.exports = (app) => {
  ...
  app.post("/block", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/block", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/blocks", UserAuth, async (req, res, next) => {
    try {
  ...
  app.post("/multiblocks", UserAuth, async (req, res, next) => {
    try {
