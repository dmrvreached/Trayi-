...
const Service = require("../services/farmOperations-service");
...
module.exports = (app) => {
    ...
    app.post("/farmOperations", UserAuth, async (req, res, next) => {
    try {
    ...
    app.delete("/farmOperations", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/farmOperations", UserAuth, async (req, res, next) => {
    try {
