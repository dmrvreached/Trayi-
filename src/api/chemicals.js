const StateService = require("../services/chemicals-service");
...
module.exports = (app) => {
  ...
  app.post("/chemicalname", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/chemicalname", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/chemicalnames", UserAuth, async (req, res, next) => {
    try {
