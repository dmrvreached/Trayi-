...
const Service = require("../services/farmerFAQ-service");
...
module.exports = (app) => {
    ...
    app.post("/farmerFAQ", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.delete("/farmerFAQ", UserAuth, async (req, res, next) => {
    try {
        const { id } = req.query;
    ...
    app.get("/farmerFAQ", UserAuth, async (req, res, next) => {
    try {
