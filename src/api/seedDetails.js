...
const Service = require("../services/seedDetails-service");
...
module.exports = (app) => {
    ...
    app.post("/seedDetails", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.delete("/seedDetails", UserAuth, async (req, res, next) => {
        try {
            const { id } = req.query;
    ...
    app.get("/seedDetails", UserAuth, async (req, res, next) => {
        try {
