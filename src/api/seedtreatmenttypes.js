const StateService = require("../services/seedtreatmenttypes-service");
...
module.exports = (app) => {
  ...
  app.post("/seedtreatmenttype", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/seedtreatmenttype", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/seedtreatmenttypes", UserAuth, async (req, res, next) => {
    try {
