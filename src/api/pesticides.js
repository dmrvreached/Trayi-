const StateService = require("../services/pesticides-service");
...
module.exports = (app) => {
  ...
  app.post("/pesticides", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.delete("/pesticides", UserAuth, async (req, res, next) => {
    try {
      const { id } = req.query;
  ...
  app.get("/pesticides", UserAuth, async (req, res, next) => {
    try {
